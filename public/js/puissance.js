        ...
        function clickEvent()
        {
            ...
            while (k>-1)
            {
                if (board[k][l]==0)
                {
                    ...
                    divElt.style.backgroundColor=player==1?"#6d071a":"#7fbca7"; 
                    board[k][l]=player;
    ...
    // Fonction de Vérification de victoire
        function verifVictoire(i,j)
        {
            ...
            // Affichage Résultat
                if(countLigne>=4||countColonne>=4||countDiag>=4||countAntiDiag>=4)
                {
                    ...
                    // On supprime les évènements clics
                        for (let i=0; i<ligne;i++)
                        {
                            ...
                            {
                                let caseElt=document.getElementById("L"+i+"C"+j);
                                caseElt.style.backgroundColor= "#DEB887"; 
                ...
                {
                    console.log("tour suivant");// Affichage Tour suivant 
                };
        }
